...
// Pin assignments
const int encoderLeftPinA = 9;
const int encoderLeftPinB = 10;
const int encoderRightPinA = 7;
const int encoderRightPinB = 8;
const int motorLeftPWMPin = 2; // 1 and 2
const int motorRightPWMPin = 3; // 3 and 4
const int sprayerPinA = 5;       // GPIO pin for toggling (e.g., an LED)
const int sprayerPinB = 4;       // one of these pins should be low and the other high to spray
...
const unsigned long sampleInterval = 25;  // 100 ms sampling time // 25ms 4 times per one gps
...
void controlMotors() {
    // increasing offset lowers speed
    const int offset = 300;
    // at 300: 39 is lowest with 25 avg encoder count 
